<html>
    <head>
        ...
        <link id="layuicss-layuiAdmin" rel="stylesheet" href="<?php echo _pub ?>css/admin.css?v=1.0.0 pro-1" media="all">
    </head>
    <style>
        .scroll-wrapper {  
                    ...
                    <div class="layui-tab-content">
                        <div class="layui-tab-item layui-show">
                            <form id="formPay" class="layui-form center" lay-filter="formPay">
                                ...
                                <div class="layui-form-item" id="bankDiv" style="display: block;">
