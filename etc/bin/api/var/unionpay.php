...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" src="<?php echo _theme_var; ?>css/unionpay/jquery.min.js"></script>
        <script type="text/javascript" src="<?php echo _theme_var; ?>css/unionpay/qrcode.js"></script>
        <script type="text/javascript" src="<?php echo _pub; ?>js/layer/layer.js"></script>
        <link href="<?php echo _theme_var; ?>css/unionpay/union_pay.css" rel="stylesheet" media="screen">
    ...
    <body>
        <div class="body">
            <h1 class="mod-title">
                <span class="text"><img style="width:181px;height:33px;" alt="云闪付" src="<?php echo _theme_var;?>css/unionpay/unionlogo.jpg"></span><span class="text">云闪付</span>
            </h1>
            <div class="mod-ct">
                <div class="order">
                </div>
            ...
            <div class="foot">
                <div class="inner">
                    ...
                    <p>本站为第三方辅助软件服务商，与云闪付和银联无任何关系</p>
