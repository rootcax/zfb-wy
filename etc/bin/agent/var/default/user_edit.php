    ...
    <body>    
        <form class="layui-form" style="margin-top: 20px;" id="from">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="money" value="<?php echo $data['balance']; ?>" class="layui-input" style="width: 98%;" disabled="disabled">
                </div>
            </div>
        ...
        //添加
                form.on('submit(add)', function () {
                    ...
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "<?php echo functions::get_Config('webCog')['site'] . 'agent.php?b=action&c=user_edit&id=' . $data['id']; ?>",
                        data: $('#from').serialize(),
