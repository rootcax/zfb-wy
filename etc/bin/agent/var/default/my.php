    ...
    <body>    
        <form class="layui-form" style="margin-top: 20px;" id="from">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    if (!empty($agent->avatar)) {
                        echo _pub . 'upload/' . $user->sid . '/images/' . $agent->avatar;
                    } else {
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="layui-form-mid layui-word-aux"><?php echo $agent->phone; ?></div>  
                </div>
            </div>
        ...
        function pwds() {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo functions::urlc('agent', 'action', 'edit') ?>",
                data: $('#from').serialize(),
        ...
        function uploadPic() {
            ...
            $.ajax({
                url: "<?php echo functions::urlc('agent', 'action', 'avatar') ?>",
                type: "post",
                // Form数据
                data: fd,
                cache: false,
