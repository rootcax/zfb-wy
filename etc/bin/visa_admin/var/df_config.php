...
<div>
    ...
    <div style="padding: 15px;">
        ...
        <form class="layui-form" style="margin-top: 20px;" id="from">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">手续费模式</label>
                <div class="layui-input-block">
                    <input type="radio" name="fee_mode" value="1" title="百分比" <?php if ($data['fee_mode'] == 1) echo 'checked'; ?>>
                    <input type="radio" name="fee_mode" value="2" title="固定值" <?php if ($data['fee_mode'] == 2) echo 'checked'; ?>>
                </div>
            </div>
...
//添加
        form.on('submit(edit)', function () {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo functions::get_Config('webCog')['site'] . 'visa_admin.php?b=action&c=df_config'; ?>",
                data: $('#from').serialize(),
