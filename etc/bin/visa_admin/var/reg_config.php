        ...
        <form class="layui-form" style="margin-top: 20px;" id="from">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="balance" value="<?php echo $data['balance']; ?>" class="layui-input" style="width: 98%;">
                </div>
            </div>
...
//添加
        form.on('submit(edit)', function () {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo functions::get_Config('webCog')['site'] . 'visa_admin.php?b=action&c=reg_config'; ?>",
                data: $('#from').serialize(),
