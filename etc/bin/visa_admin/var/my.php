...
<form class="layui-form" style="margin-top: 20px;" id="from">
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <div class="layui-form-mid layui-word-aux"><?php echo $data['username']?></div>
    </div>
  </div>
    ...
    <div class="layui-input-block">
        <input type="text" name="pwd" placeholder="请输入手机号码" class="layui-input" value="<?php echo $data['phone']?>" style="width: 98%;">
    </div>
  </div>
...
//添加
  form.on('submit(add)', function(){
	  	...
	  	$.ajax({
	          type: "POST",
	          dataType: "json",
	          url: "<?php echo functions::get_Config('webCog')['site'] . 'visa_admin.php?b=action&c=edit'?>",
	          data: $('#from').serialize(),
