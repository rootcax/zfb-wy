        ...
        <form class="layui-form" style="margin-top: 20px;" id="from">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="username" placeholder="请输入你的收款账号.." class="layui-input" style="width: 98%;" value="<?php echo $data['username']; ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="typec" value="26" title="支付宝" lay-filter="typec" <?php if ($data['typec'] == 26) echo 'checked'; ?> disabled>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="qr_typec" value="1" title="固码" <?php if ($data['qr_typec'] == 1) echo 'checked'; ?> lay-filter="qr_typec" <?php if ($data['typec'] == 17 || $data['typec'] == 99) echo 'disabled'; ?>>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="limit_time" placeholder="请输入收款账户相同金额收款限制时间" class="layui-input" style="width: 98%;" value="<?php echo $data['limit_time'] ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="min_amount" placeholder="请输入收款账户收款单笔最小金额" class="layui-input" style="width: 98%;" value="<?php echo $data['min_amount'] ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="max_amount" placeholder="请输入收款账户收款单笔最大金额" class="layui-input" style="width: 98%;" value="<?php echo $data['max_amount'] ?>">
            ...
            <div class="layui-form-item" id="otorder_limit">
                ...
                <div class="layui-input-block">
                    <input type="text" name="otorder_limit" placeholder="请输入超时订单笔数.." class="layui-input" style="width: 98%;" value="<?php echo $data['otorder_limit'] ?>">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="requota" placeholder="请输入收款额度.." class="layui-input" style="width: 98%;" value="<?php echo $data['requota']; ?>">
                    <div class="layui-form-mid layui-word-aux">收款额度每日更新，使用完以后自动关闭收款，输入 -1 表示不限额，输入 0 表示关闭该收款账号</div>
                </div>
            </div>

            <div class="layui-form-item">
                <label class="layui-form-label">回调类型</label>
                <div class="layui-input-block"  style="width: 100px;">
                    <select name="send_type">
                        <option value="get" <?php if ($json->method == 'get') echo 'selected'; ?> >GET</option>
                        <option value="post" <?php if ($json->method == 'post') echo 'selected'; ?> >POST</option>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="polling" value="0" title="关闭" <?php if ($data['polling'] == 0) echo 'checked'; ?>>
                    <input type="radio" name="polling" value="1" title="开启" <?php if ($data['polling'] == 1) echo 'checked'; ?>>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input type="radio" name="pattern" value="3" title="PC监控" <?php if ($data['pattern'] == 3) echo 'checked'; ?>>
                </div>
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit type="button" lay-filter="edit">确认修改</button>
                        ...
                        layui.use(['form', 'layedit'], function () {
                            ...
                            form.on('submit(edit)', function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "json",
                                    url: "<?php echo functions::urlc('user', 'api', 'land_edit', array('csrf' => functions::getcsrf(), 'id' => intval($_GET['id']))) ?>",
                                    data: $('#from').serialize(),
