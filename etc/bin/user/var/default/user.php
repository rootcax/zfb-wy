            ...
            <tbody>
                <?php foreach ($data['query'] as $minet) { ?>
                    <tr>
                        ...
                        <td <?php if ($minet['status'] == 0) { ?>style='color: #985f0d;font-weight:bold;'<?php } else if ($minet['status'] == 1) { ?>style='color: green;font-weight:bold;'<?php } else { ?>style='color: red;font-weight:bold;'<?php } ?>><?php
                            if ($minet['status'] == 0) {
                                echo '未审核';
                        ...
                        <td>
                            <input id="checkbox_S_<?php echo $minet['id']; ?>" class="switch switch-anim" onchange="updateSwitch(<?php echo $minet['id']; ?>)" type="checkbox">
                        </td>
