...
class MAIN {
    ...
    private function LOCAL_SET($mvc) {
        ...
        //载入支付宝当面付支持库
        require_once _lib . 'SignService.php';
        //载入系统函数库
        ...
        //定义前端模板绝对路径
        define('_theme', functions::get_Config('webCog')['site'] . 'etc/' . $this->bin . '/' . $mvc['modular'] . '/var/' . functions::get_Config('webCog')['theme'] . '/');
        //定义var模板绝对路径
        define('_theme_var', functions::get_Config('webCog')['site'] . 'etc/' . $this->bin . '/' . $mvc['modular'] . '/var/');
        //定义public绝地路径
